...
import {
    faClock,
    faEdit,
  faEraser, faPencilAlt, faTimesCircle, faTrashAlt,
  ...
  return (
    <div className="BaYscc">
      <div className="cRDmYy d-flex justify-content-between">
        ...
        <a href="#" style={{color:'black'}}>Math 1</a>
        </div>
        <div className="align-self-center"><FontAwesomeIcon icon={faClock} style={{marginRight:'0.5rem', size:'md'}}></FontAwesomeIcon></div>
      </div>
